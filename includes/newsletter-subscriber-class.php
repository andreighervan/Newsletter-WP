...
echo $args['before_widget'];
        ...
        <form id="subscriber-form" method="post" action="<?php echo plugins_url().'/newsletter-subscriber/includes/newsletter-subscriber-mailer.php';?>">
            ...
            <input type="submit" class="btn btn-primary" name="subscriber_submit" value="Subscribe"><br><br>
        </form>
    ...
    public function form( $instance ) {
        ...
        $subject=$instance['subscriber']?$instance['subscriber']:__('You have a new subscriber','ns_domain');
        ?>
...
<p><label for="<?php echo $this->get_field_id('recipient');?>"><?php _e('Recipient');?></label><br>
    <input type="text" id="<?php echo $this->get_field_id('recipient');?>" name="<?php echo $this->get_field_name('recipient');?>" value="<?php echo esc_attr($recipient);?>"></p>
<p><label for="<?php echo $this->get_field_id('subject');?>"><?php _e('Subject');?></label><br>
    <input type="text" id="<?php echo $this->get_field_id('subject');?>" name="<?php echo $this->get_field_name('subject');?>" value="<?php echo esc_attr($subject);?>"></p>
<?php
}
